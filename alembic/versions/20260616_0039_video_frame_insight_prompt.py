"""video frame insight prompt registry shadow

Revision ID: 20260616_0039
Revises: 20260616_0038
Create Date: 2026-06-16 18:55:00
"""
...
BINDING_ID = "global:video_frame_insight:v1"
...
def downgrade() -> None:
    op.execute("DELETE FROM expression_prompt_bindings WHERE id = 'global:video_frame_insight:v1'")
    op.execute("DELETE FROM expression_prompt_versions WHERE id = 'video_frame_insight:v1'")
    op.execute("DELETE FROM expression_prompt_templates WHERE id = 'video_frame_insight'")
